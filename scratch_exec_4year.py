"""Execute 4-Year Macro Market Curves Notebook and populate cell outputs."""
...
def execute_notebook(nb_path: str):
    ...
    print(f"🚀 Executing 4-Year notebook {nb_path} ({len(nb['cells'])} cells)...")
    exec_globals = {
        "__name__": "__main__",
    ...
    for idx, cell in enumerate(nb["cells"]):
        ...
        try:
            ...
            print(f"✅ Cell {execution_count} succeeded. Output preview: {full_out.strip()[:140]}...")
            execution_count += 1
...
if __name__ == "__main__":
    execute_notebook("kaggriculture-self-training/qkd_4year_market_curves_training.ipynb")
    execute_notebook("qkd_4year_market_curves_training.ipynb")
